...
export interface ApiClassDecisionClassDecision
  extends Struct.CollectionTypeSchema {
  collectionName: 'class_decisions';
  info: {
    description: 'Decision to open a class or recognize completion';
    displayName: 'Quy\u1EBFt \u0111\u1ECBnh';
    pluralName: 'class-decisions';
    singularName: 'class-decision';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    decision_number: Schema.Attribute.String & Schema.Attribute.Required;
    end_date: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::class-decision.class-decision'
    > &
      Schema.Attribute.Private;
    notes: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    related_decision: Schema.Attribute.Relation<
      'oneToOne',
      'api::class-decision.class-decision'
    >;
    school_class: Schema.Attribute.Relation<
      'manyToOne',
      'api::school-class.school-class'
    >;
    signed_date: Schema.Attribute.Date;
    signer_name: Schema.Attribute.String;
    start_date: Schema.Attribute.Date;
    students: Schema.Attribute.Relation<'manyToMany', 'api::student.student'>;
    training_course: Schema.Attribute.String;
    type: Schema.Attribute.Enumeration<['OPENING', 'RECOGNITION']> &
...
export interface ApiClassSubjectClassSubject
  extends Struct.CollectionTypeSchema {
  collectionName: 'class_subjects';
  info: {
    description: 'Mapping t\u1EEB b\u1EA3ng class_subjects';
    displayName: 'L\u1EDBp h\u1ECDc - M\u00F4n h\u1ECDc (Legacy)';
...
export interface ApiExamApprovalExamApproval
  ...
  info: {
    description: 'Stores exam approval status for students in a class decision';
    displayName: 'Duy\u1EC7t thi';
  ...
  attributes: {
    approvals: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    decision: Schema.Attribute.Relation<
      'oneToOne',
      'api::class-decision.class-decision'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiExamGradeExamGrade extends Struct.CollectionTypeSchema {
  collectionName: 'exam_grades';
  info: {
    description: 'Stores exam grades for a class decision';
    displayName: '\u0110i\u1EC3m thi';
    pluralName: 'exam-grades';
    singularName: 'exam-grade';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiNationNation extends Struct.CollectionTypeSchema {
  collectionName: 'nations';
  info: {
    description: 'Nations table';
...
export interface ApiPrintTemplatePrintTemplate
  extends Struct.CollectionTypeSchema {
  collectionName: 'print_templates';
  info: {
    description: 'Stores print templates for decisions and certificates';
    displayName: 'M\u1EABu in \u1EA5n';
    pluralName: 'print-templates';
    singularName: 'print-template';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::print-template.print-template'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiStudentDocumentStudentDocument
  ...
  info: {
    description: 'Student Documents table';
    displayName: 'H\u1ED3 s\u01A1 h\u1ECDc vi\u00EAn';
...
export interface ApiSubjectSubject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    exam_hours: Schema.Attribute.Decimal;
    exercise_hours: Schema.Attribute.Decimal;
    has_practice: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    has_theory: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::subject.subject'
    ...
    name: Schema.Attribute.String;
    notes: Schema.Attribute.Text;
    practice_hours: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    sessions: Schema.Attribute.Integer;
    theory_hours: Schema.Attribute.Decimal;
...
export interface ApiTeacherSubjectTeacherSubject
  ...
  info: {
    description: 'Mapping t\u1EEB b\u1EA3ng teacher_subjects';
    displayName: 'Gi\u1EA3ng vi\u00EAn - M\u00F4n h\u1ECDc (Legacy)';
...
export interface ApiTrainingAssignmentTrainingAssignment
  extends Struct.CollectionTypeSchema {
  collectionName: 'training_assignments';
  info: {
    description: 'Stores the training schedule for a class decision';
    displayName: 'Ph\u00E2n c\u00F4ng gi\u1EA3ng d\u1EA1y';
    pluralName: 'training-assignments';
    singularName: 'training-assignment';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::training-assignment.training-assignment'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::class-decision.class-decision': ApiClassDecisionClassDecision;
      ...
      'api::exam-grade.exam-grade': ApiExamGradeExamGrade;
      'api::nation.nation': ApiNationNation;
      'api::print-template.print-template': ApiPrintTemplatePrintTemplate;
      ...
      'api::training-assignment.training-assignment': ApiTrainingAssignmentTrainingAssignment;
